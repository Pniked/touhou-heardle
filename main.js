var app = (function () {
 ...
 //Touhou 6 NC OST
 "TH6 EoSD (NC) - A Dream More Scarlet than Red (赤より紅い夢)",
 "TH6 EoSD (NC) - A Soul as Red as a Husk Cherry (ほおずきみたいに紅い魂)",
 "TH6 EoSD (NC) - Apparitions Stalk the Night (妖魔夜行)",
 "TH6 EoSD (NC) - Lunate Elf (ルーネイトエルフ)",
 "TH6 EoSD (NC) - Lovestruck Tomboy (おてんば恋娘)",
 "TH6 EoSD (NC) - Shanghai Scarlet Teahouse ~ Chinese Tea (上海紅茶館 ～ Chinese Tea)",
 "TH6 EoSD (NC) - Shanghai Alice of Meiji 17 (明治十七年の上海アリス)" ,
 "TH6 EoSD (NC) - Voile, the Magic Library (ヴワル魔法図書館)",
 "TH6 EoSD (NC) - An Eternity More Transient than Scarlet (紅より儚い永遠)",
 "TH6 EoSD (NC) - Locked Girl ~ The Girl's Sealed Room (ラクトガール　～ 少女密室)",
 "TH6 EoSD (NC) - The Maid and the Pocket Watch of Blood (メイドと血の懐中時計)",
 "TH6 EoSD (NC) - Lunar Clock ~ Luna Dial (月時計　～ ルナ・ダイアル)",
 "TH6 EoSD (NC) - The Young Descendant of Tepes (ツェペシュの幼き末裔)",
 "TH6 EoSD (NC) - Septette for a Dead Princess (亡き王女の為のセプテット)",
 "TH6 EoSD (NC) - The Centennial Festival for Magical Girls (魔法少女達の百年祭)",
 "TH6 EoSD (NC) - U.N. Owen Was Her? (U.N.オーエンは彼女なのか？)",
 "TH6 EoSD (NC) - The Scarlet Devil Appears at Last (スカーレットデビルは遅れて顕れる)",
 "TH6 EoSD (NC) - Scarlet Chamber ~ Eastern Dream... (紅楼 ～ Eastern Dream...)",
 //Touhou 7 OST
 ...
 "TH19 UDoALG - The Primal Scene of Japan the Girl Saw (少女が見た日本の原風景)",
 "TH19 UDoALG - Spiritual Domination ~ Who done it! (妖々跋扈　〜 Who done it!)",
 "TH19 UDoALG - A Pair of Divine Beasts (一対の神獣)",
 "TH19 UDoALG - At the Harbor of Spring (春の湊に)",
 "TH19 UDoALG - Unforgettable, the Nostalgic Greenery (忘れがたき、よすがの緑)",
 "TH19 UDoALG - Corpse Voyage ~ Be of good cheer! (死体旅行　〜 Be of good cheer!)",
 "TH19 UDoALG - The Long-Awaited Oumagatoki (待ちわびた逢魔が時)",
 "TH19 UDoALG - Futatsuiwa from Sado (佐渡の二ッ岩)",
 "TH19 UDoALG - Tortoise Dragon ~ Fortune and Misfortune (トータスドラゴン　〜 幸運と不運)",
 "TH19 UDoALG - Prince Shoutoku's Pegasus ~ Dark Pegasus (聖徳太子のペガサス　〜 Dark Pegasus)",
 "TH19 UDoALG - Memento of the Avaricious Beast (強欲な獣のメメント)",
